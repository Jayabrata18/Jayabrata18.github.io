...
describe('application tests', () => {
  ...
  it('should render name: Jayabrata Pramanik', () => {
    const element = screen.getByTestId('name');

    checkContent(element, /^Jayabrata Pramanik$/);
  });
  ...
  it('should render creator', () => {
    ...
    checkContent(element, /^Jayabrata Pramanik$/, 'https://www.jayabratapramanik.com/');
  });
  ...
  it('should render link to source code', () => {
    ...
    checkContent(
      element,
      /^Source$/,
      'https://github.com/Jayabrata18/Jayabrata18.github.io/'
    );
  });
  ...
  it('should render LinkedIn button', () => {
    ...
    checkButton(
      ...
      child,
      /^LinkedIn$/,
      'https://www.linkedin.com/in/jayabrata-pramanik/'
    );
  });
  ...
  it('should render Resume button', () => {
    ...
    checkButton(
      ...
      child,
      /^Resume$/,
      'https://drive.google.com/file/d/1dKdO7MVJcxrrPm6Ya1h5H057vd5TPgcY/view?usp=drive_link'
    );
  });
  ...
  it('should render Email button', () => {
    ...
    checkButton(parent, child, /^Email$/, 'mailto:jayabrata180402@gmail.com');
  });
  ...
  it('should render full footer on desktop', () => {
    ...
    expect(footer).toHaveTextContent(
      /^Designed and built by Jayabrata Pramanik \| Source$/
    );
  });
});
...
describe('app context tests', () => {
  it('should render partial footer on mobile', () => {
    ...
    expect(footer).toHaveTextContent(/^Designed and built by Jayabrata Pramanik$/);
